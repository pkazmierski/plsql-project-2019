...
CREATE TABLE payments_for_reservation (
    reservation_id  INTEGER NOT NULL,
    payment_id      INTEGER NOT NULL
)
LOGGING;

COMMENT ON TABLE payments_for_reservation IS
    'Stores informations about payments (including partial payments) for reservations.';

ALTER TABLE payments_for_reservation ADD CONSTRAINT payments_for_reservation_pk PRIMARY KEY ( payment_id,
                                                                                              reservation_id );
